...
class TestInCustodyIdsScraper:
    ...
    @patch('scraper.in_custody_ids.ShelterLuvScraper')
    def test_scrape_in_custody_ids_integration(self, mock_scraper_class):
        ...
        mock_scraper_class.return_value.__exit__.return_value = None

        # Mock page
        mock_page = Mock()
        mock_scraper.session.page = mock_page
        ...
        mock_scraper_class.assert_called_once_with("user", "pass")

        # Verify navigation was called
        mock_page.goto.assert_called_once_with("https://new.shelterluv.com/dashboard?tab=animals")
