...
def get_animal_memos(api_key: str, internal_id: str) -> MemoResult:
    ...
    try:
        ...
        return MemoResult(
            internal_id=internal_id, memos_html=memos_html, source="api", api_failed=False
        )

    except ApiError as e:
        return MemoResult(internal_id=internal_id, memos_html="", source="api", api_failed=True)
