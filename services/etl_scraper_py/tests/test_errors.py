...
from errors import ApiError, EtlError, SchemaValidationError, ScraperError
...
class TestErrors:
    ...
    def test_etl_error_inheritance(self):
        ...
        assert str(error) == "ETL Error: Test ETL error"
    ...
    def test_api_error_inheritance(self):
        ...
        assert isinstance(error, Exception)
        assert str(error) == "API Error: Test API error"
    ...
    def test_scraper_error_inheritance(self):
        ...
        assert isinstance(error, EtlError)
        assert isinstance(error, Exception)
        assert str(error) == "Scraper Error: Test scraper error"
    ...
    def test_schema_validation_error_inheritance(self):
        ...
        assert isinstance(error, EtlError)
        assert isinstance(error, Exception)
        assert str(error) == "Schema Validation Error: Test schema error"
    ...
    def test_error_with_custom_message(self):
        ...
        for msg in messages:
            error = EtlError(msg)
            assert str(error) == f"ETL Error: {msg}"
