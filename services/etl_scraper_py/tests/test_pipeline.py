...
class TestIncrementalScraping:
    ...
    def test_transform_processes_scraped_data(self):
        ...
        with patch("foster_mapping.build_foster_maps", return_value={}), patch(
            "foster_mapping.build_event_maps", return_value={}
        ), patch("enrichment.build_dog_record") as mock_build_dog:

            mock_build_dog.return_value = {
                "Internal-ID": "1",
                "ID": "A1",
                "Name": "Dog 1",
                "Status": "AVAILABLE",
    ...
    def test_transform_processes_all_scraped_data(self):
        ...
        extract_result = ExtractResult(
            ...
            memos_data={},
            scraped_map={"1": {"scraped": "data1"}, "2": {"scraped": "data2"}},
        )
