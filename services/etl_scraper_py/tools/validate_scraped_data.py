...
def validate_dog_record_comprehensive(
    dog_data: Dict[str, Any], schema: Dict[str, Any]
) -> tuple[bool, List[str]]:
    """
...
def main():
    ...
    try:
        ...
        invalid_comprehensive_valid, invalid_errors = validate_dog_record_comprehensive(
            invalid_dog, schema
        )
        print(
            f"Invalid data correctly rejected: {'YES' if not invalid_comprehensive_valid else 'NO'}"
        )
